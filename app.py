...
MODE_DESCRIPTIONS = {
    "Dental Enhancement": "Γενική βελτίωση της ακτινογραφίας για πιο καθαρή και ευκρινή εικόνα. Χρήσιμο ως επιλογή για καθημερινή χρήση.",
    "Endodontic Preset": "Βελτιώνει την ορατότητα των ριζών, των ριζικών σωλήνων και λεπτών ενδοδοντικών λεπτομερειών. Χρήσιμο σε ενδοδοντικό έλεγχο.",
    "Perio / Bone Preset": "Αναδεικνύει καλύτερα το φατνιακό οστό και τις περιοδοντικές δομές. Χρήσιμο για την αξιολόγηση της οστικής εικόνας.",
    "Enhance Contrast": "Ενισχύει τη διαφορά ανάμεσα σε φωτεινές και σκοτεινές περιοχές. Χρήσιμο όταν η ακτινογραφία φαίνεται επίπεδη ή έχει χαμηλή αντίθεση.",
    "Histogram Equalization": "Βελτιώνει συνολικά την αντίθεση της εικόνας. Μπορεί να βοηθήσει όταν διαφορετικές περιοχές της ακτινογραφίας δεν ξεχωρίζουν εύκολα.",
    "CLAHE": "Ενισχύει την τοπική αντίθεση σε διαφορετικές περιοχές της εικόνας. Χρήσιμο για την ανάδειξη τοπικών ανατομικών λεπτομερειών.",
    "Endo Sharp": "Αναδεικνύει λεπτές ακμές και μικρές ανατομικές λεπτομέρειες. Ιδιαίτερα χρήσιμο σε ακτινογραφίες όπου θέλουμε καλύτερη ορατότητα γύρω από ρίζες και ριζικούς σωλήνες.",
    "Gaussian Blur": "Εξομαλύνει την εικόνα και μειώνει μικρές διακυμάνσεις. Χρησιμοποιείται κυρίως για μείωση θορύβου ή ως στάδιο προεπεξεργασίας.",
    "Median Filter": "Μειώνει μικρό θόρυβο διατηρώντας σχετικά καλά τα όρια των δομών. Χρήσιμο όταν η εικόνα έχει μικρές μεμονωμένες ατέλειες.",
    "Mean Filter": "Εξομαλύνει την εικόνα με μέσο όρο γειτονικών pixel. Χρήσιμο για ήπια μείωση θορύβου, με πιθανή απώλεια λεπτών λεπτομερειών.",
    "Unsharp Mask": "Ενισχύει τις λεπτές λεπτομέρειες και τις ακμές. Χρήσιμο όταν η ακτινογραφία φαίνεται ελαφρώς θολή.",
    "Sharpen": "Ενισχύει την ευκρίνεια των ορίων και των ανατομικών δομών. Χρήσιμο όταν θέλουμε πιο έντονη αίσθηση λεπτομέρειας.",
    "Find Edges / Sobel": "Αναδεικνύει κυρίως τα όρια των δομών. Χρήσιμο για τη μελέτη περιγραμμάτων και ακμών, περισσότερο ως εργαλείο οπτικής επεξεργασίας.",
    "Laplacian Enhancement": "Ενισχύει μικρές αλλαγές και λεπτές ακμές. Χρήσιμο όταν θέλουμε να τονίσουμε μικρές λεπτομέρειες της εικόνας.",
    "Convolve": "Εφαρμόζει διαφορετικά φίλτρα στην εικόνα για ενίσχυση, ανάδειξη ακμών ή άλλη ειδική επεξεργασία.",
    "Minimum": "Επεκτείνει τις πιο σκοτεινές περιοχές και μειώνει μικρές φωτεινές λεπτομέρειες. Χρήσιμο κυρίως για ειδική επεξεργασία εικόνας.",
    "Maximum": "Επεκτείνει τις πιο φωτεινές περιοχές και μειώνει μικρές σκοτεινές λεπτομέρειες. Χρήσιμο κυρίως για ειδική επεξεργασία εικόνας.",
    "Morphological Opening": "Μπορεί να απομακρύνει μικρές φωτεινές ατέλειες ή θόρυβο, διατηρώντας μεγαλύτερες δομές.",
    "Morphological Closing": "Μπορεί να γεμίσει μικρά σκοτεινά κενά και να βελτιώσει τη συνέχεια φωτεινών περιοχών.",
    "Subtract Background": "Μειώνει ανομοιομορφίες στη φωτεινότητα της ακτινογραφίας. Χρήσιμο όταν διαφορετικές περιοχές έχουν διαφορετικό επίπεδο φωτισμού.",
    "Gamma Correction": "Ρυθμίζει τη φωτεινότητα της εικόνας. Χρήσιμο όταν η ακτινογραφία είναι πολύ σκοτεινή ή πολύ φωτεινή.",
}
...
# Εμφάνιση του Disclaimer στο κάτω μέρος της εφαρμογής
st.markdown("---")
st.warning(
    "**⚠️ Αποποίηση Ευθύνης (Disclaimer):** "
    "Η παρούσα εφαρμογή προορίζεται **αποκλειστικά για ερευνητικούς και εκπαιδευτικούς σκοπούς**. "
    "Δεν αποτελεί πιστοποιημένο ιατρικό λογισμικό και δεν πρέπει να χρησιμοποιείται για κλινική διάγνωση "
    "ή σχεδιασμό θεραπείας ασθενών. Η χρήση της γίνεται με αποκλειστική ευθύνη του χρήστη."
)
